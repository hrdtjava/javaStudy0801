...
public class LocalDateTimeEx3 {
	...
	public static void main(String[] args) {
		...
		// 날짜를 비교할 수 있다.
		LocalDateTime startDateTime = LocalDateTime.now();// 오늘 -> 기준날짜
		LocalDateTime endDateTime = LocalDateTime.of(2025, 11, 24, 5, 0, 0); //비교,예약		
		...
		if (startDateTime.isAfter(endDateTime)) {
			...
			System.out.println("예약이 가능!");
		} else {
			System.out.println("선택날짜 이후가 아닙니다.");
			System.out.println("예약이 불가능!");
		}
		System.out.println();		
		// 날짜 비교 2 -> 차이		
		LocalDateTime day1= LocalDateTime.of(2025,8, 18, 14, 10,30);
		LocalDateTime day2= LocalDateTime.of(2026,11, 14, 14, 10,30);		
