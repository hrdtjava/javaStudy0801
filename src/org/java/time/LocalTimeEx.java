...
public class LocalTimeEx {
	...
	public static void main(String[] args) {
		...
		System.out.println("LocalTime"); //시간만
		...
		System.out.println(localTime.getNano());//나노 -> 나노초(nanosecond, ns)는 10억 분의 1초

		System.out.println(localTime.getHour() + "시 " + localTime.getMinute() + "분 " 
		...
		System.out.println(localTime2.getHour() + "시 "	+ localTime2.getMinute() + "분 " 
