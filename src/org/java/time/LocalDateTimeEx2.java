...
public class LocalDateTimeEx2 {
	...
	public static void main(String[] args) {
		...
		LocalDate today = LocalDate.now(); // 현재날짜 2024-11-14
		...
		System.out.println(period.getYears());  // 년	-2
		System.out.println(period.getMonths()); // 월	-1
		System.out.println(period.getDays());   // 일   today-oldDate -16
		...
		long days = ChronoUnit.DAYS.between(oldDate, today);  // 일 차이 -776
		System.out.println(days);    //  전체일수 비교 
		System.out.println(ChronoUnit.MONTHS.between(oldDate, today)); // 월 차이 -25
		System.out.println(ChronoUnit.YEARS.between(oldDate, today));  // 년 차이 -2
